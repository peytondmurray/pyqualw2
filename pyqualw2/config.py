...
from .data import Bathymetry, TemperatureProfile
...
class Config:
    ...
    def __init__(
        self, con: PathLike, bathymetry: Bathymetry, temperature: TemperatureProfile
    ):
        self.con = con
    ...
    def from_csv(
        ...
        return cls(
            ...
            temperature=TemperatureProfile.from_file(temperature),
        )
